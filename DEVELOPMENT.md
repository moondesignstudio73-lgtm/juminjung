...
- The portrait catalog selects authored assets per expression with a neutral fallback; Eleanor and Ruth have afraid and injured variants, Mia and Claire have afraid and happy variants, Walter and Daniel have suspicious and happy variants, Samuel has sad and happy variants, Mr. White and Vale have suspicious variants, Owen and Hayes have angry variants, Lily has a happy variant, and save restoration refreshes variant paths from the catalog
...
- Expand authored expression and condition variants from the 12 completed characters to the remaining eight-character portrait catalog
