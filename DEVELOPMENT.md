...
- Eleanor, Walter, Mia, Ruth, Owen, Hayes, Lily, Rosa, and Vale now appear as large authored half-body 2D sprites at the front desk and in their story scenes
...
- Produce matching half-body sprite sets for the remaining eleven NPCs and replace the current CSS-derived state treatment with authored expression and condition variants
