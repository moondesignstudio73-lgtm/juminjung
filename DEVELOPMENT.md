...
- Eleanor now appears as a large authored half-body 2D sprite at the front desk and in her story scenes
...
- Produce matching half-body sprite sets for the remaining nineteen NPCs and replace the current CSS-derived state treatment with authored expression and condition variants
