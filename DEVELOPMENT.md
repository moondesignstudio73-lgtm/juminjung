...
- The portrait catalog selects authored assets per expression with a neutral fallback; Eleanor and Ruth have afraid and injured variants, Mia and Claire have afraid and happy variants, Walter, Daniel, Jack, and Grace have suspicious and happy variants, Samuel and Noah have sad and happy variants, Mr. White and Vale have suspicious variants, Owen and Hayes have angry variants, Lily has a happy variant, and save restoration refreshes variant paths from the catalog
...
- Expand authored expression and condition variants from the 15 completed characters to the remaining five-character portrait catalog
