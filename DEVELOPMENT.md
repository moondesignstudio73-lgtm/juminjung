...
- Complete resolution cutscenes in branch pairs: once either choice is illustrated, finish its alternate before moving to another event. Each branch must own distinct 1672×941 artwork, use the same data-driven trigger and serialized queue contract, make at least one material benefit and one cost legible in its composition, and clear a built Pages preview check
