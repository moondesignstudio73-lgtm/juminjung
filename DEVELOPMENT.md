...
- Ending narratives can own dedicated full-screen artwork with a safe hotel-lobby fallback; SAFE HAVEN shows the living community, THE TRUTH reveals the archive investigation, FORTRESS shows the defended hotel, HOME reunites Ruth, Rosa, Mia, and former guests around the long table, and THE DOOR confronts the player with Room 0
