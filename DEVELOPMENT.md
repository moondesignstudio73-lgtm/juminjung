...
- Eleanor, Walter, Mia, Daniel, Samuel, Ruth, Jack, Grace, Owen, Hayes, Lily, Victor, Rosa, Vale, Hazel, Claire, and Mr. White now appear as large authored half-body 2D sprites at the front desk and in their story scenes
...
- Produce matching half-body sprite sets for the remaining three NPCs and replace the current CSS-derived state treatment with authored expression and condition variants
