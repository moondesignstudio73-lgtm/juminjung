...
test("Save v15는 근무 배치와 마지막 탐색 보고서를 보존하고 v11에는 안전한 기본값을 준다",()=>{
  ...
  assert.deepEqual({version:migrated.version,assignments:migrated.staffAssignments,day:migrated.lastScavengeDay,report:migrated.lastScavengeReport},{version:15,assignments:{},day:0,report:null});
});
