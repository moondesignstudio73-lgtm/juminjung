...
export const VISITOR_REACTIONS: VisitorReactionDefinition[] = [
  ...
  { id: "vale-room-207-evidence", guestId: "vale", label: "207호의 검은 흔적", faction: "community", dialogue: "‘207호에서 나온 검은 잔류물을 보관했습니까? 방을 얻는다면 그 흔적부터 조사하겠습니다.’", requiredFlags: { monster_room_entry_clue: true }, trustDelta: 8, riskDelta: -3, offerBonus: { medicine: 1 } },
