...
export type CutsceneId = "first_monster_sighting";
export type CutsceneDefinition = { id: CutsceneId; triggerEventId: string; kicker: string; title: string; body: string; quote: string; image: string; imageAlt: string };
