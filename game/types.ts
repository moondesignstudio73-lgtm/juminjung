...
export type NightEventEffect = { resources?: Partial<Resources>; hotelStats?: Partial<HotelStats>; reputations?: Partial<Reputations>; flags?: EventFlags; threat?: number; allGuestStress?: number; targetGuestHealth?: number; roomChange?: { roomNumber: number; status: "DAMAGED" | "LOCKED"; roomCondition: number }; guestEffects?: { guestId: string; trust?: number; stress?: number; health?: number }[]; relationshipChanges?: RelationshipChange[] };
...
export type CutsceneId = "first_night" | "first_monster_sighting" | "guest_attacked" | "generator_blackout" | "refugees_sheltered" | "refugees_denied" | "room_body_discovery";
