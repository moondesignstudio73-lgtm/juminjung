...
export type CutsceneId = "first_night" | "first_monster_sighting" | "guest_attacked" | "generator_blackout" | "refugees_sheltered" | "refugees_denied" | "room_body_discovery" | "father_radio_signal" | "father_at_gate_quarantine" | "father_at_gate_opened";
export type CutsceneDefinition = { id: CutsceneId; triggerEventId?: string; triggerChoiceId?: string; priority: number; minimumCompletedDay?: number; maximumCompletedDay?: number; kicker: string; title: string; body: string; quote: string; image: string; imageAlt: string };
