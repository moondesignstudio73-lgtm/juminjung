...
export type CutsceneDefinition = { id: CutsceneId; triggerEventId?: string; priority: number; minimumCompletedDay?: number; maximumCompletedDay?: number; kicker: string; title: string; body: string; quote: string; image: string; imageAlt: string };
