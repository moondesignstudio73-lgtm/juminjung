...
export const STORY_CHOICE_EVENTS: StoryChoiceEvent[] = [
  ...
  { id: "lily-truth", guestId: "lily", stage: "RESOLUTION", title: "누가 진실을 소유하는가", description: "복원된 기록을 세상에 공개할지, 호텔 안에서 다음 단서를 기다릴지 결정해야 합니다.", quote: "‘진실은 사람을 구할 수도 있고, 마지막 피난처를 불태울 수도 있어요.’", choices: [
    ...
    { id: "archive", label: "암호화해 호텔 금고에 보관한다", description: "기록을 해독하고 보존하되 최종 진실이 모일 때까지 공개를 미룹니다.", effect: { trust: 5, hotelStats: { security: 4 }, flags: { lily_documents_decoded: true, lily_truth_archived: true, lily_truth_broadcast: false }, discoverTrait: "OriginDocuments" } },
  ] },
