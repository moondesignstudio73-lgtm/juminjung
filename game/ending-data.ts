...
export const ENDING_CONDITIONS: EndingCondition[] = [
  ...
  { endingId: "KING_OF_THE_RUINS", name: "KING OF THE RUINS", priority: 55, description: "폐허의 가장 강력한 교역 중심지가 될 수 있습니다.", requiredFlags: { ruin_market_controlled: true }, minimumStats: { resources: 85 }, requiredFacilities: ["trade_network"], requiredReputation: { merchant: 80 }, maximumReputation: { humanitarian: 40 }, requiredStoryProgress: ["jack-resolution", "victor-resolution"] },
