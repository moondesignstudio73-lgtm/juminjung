...
export const CUTSCENES: CutsceneDefinition[] = [
  ...
  },
  {
    ...
    title: "촛불을 내려놓은 손",
    body: "그레이스 할로웨이는 집회에 쓰던 의자를 계단참에서 치우고, 닫힌 책과 꺼진 촛불 옆에 망치와 못, 석고 통을 놓았다. 사람들은 설교를 듣는 대신 깨진 난간을 붙잡고, 젖은 벽을 긁어 내고, 비가 새는 창을 천과 판자로 막았다. 누구도 믿음을 버리라고 요구하지 않았고, 누구도 믿음을 이유로 일을 지휘하지 않았다. 그날부터 구호조의 규칙은 단순했다. 함께 쓰는 곳은 함께 고치고, 가장 위험한 일은 혼자 하지 않는 것.",
    quote: "믿음은 제게 남겨 두고, 이 손은 모두가 딛는 계단을 고치게 할게요.",
    image: "/juminjung/assets/cutscenes/grace-mutual-aid-v1.png",
    imageAlt: "그레이스 할로웨이가 낡은 JUJU HOTEL 계단참에서 주민들과 난간과 벽, 빗물 새는 창을 함께 보수하는 장면.",
  },
  {
    id: "grace_pilgrimage",
    triggerStoryEventId: "grace-faith",
    triggerStoryChoiceId: "pilgrimage",
    priority: 165,
    kicker: "JUJU HOTEL · PILGRIMAGE",
    title: "문턱에 돌려놓은 열쇠",
    body: "그레이스 할로웨이는 동이 트기 전 호텔 현관에서 황동 객실 열쇠를 돌려놓았다. 프런트가 내어 준 두 꾸러미의 식량과 낡은 경전을 챙긴 사람들은 서로 거리를 둔 채 젖은 거리의 천 표식을 따라 먼저 걸었다. 따뜻한 문 안쪽에는 그들이 쓰려던 망치와 못, 석고 통이 그대로 남았다. 그레이스는 누구에게도 따라오라고 명령하지 않았고, 누구도 호텔에 남으라는 말을 듣지 않았다. 마지막으로 호텔을 돌아본 뒤 그녀는 자신의 방과 믿음의 온기, 다시 돌아올 약속을 모두 문턱 안에 두고 사람들의 뒤를 따랐다.",
    quote: "믿음이 선택이라면, 떠나는 사람도 붙잡아서는 안 되겠지요.",
    image: "/juminjung/assets/cutscenes/grace-pilgrimage-v1.png",
    imageAlt: "그레이스 할로웨이가 비 내린 새벽 JUJU HOTEL 현관에서 황동 객실 열쇠를 돌려주고, 두 식량 꾸러미와 낡은 경전을 챙긴 채 구호 도구를 호텔 안에 남겨 두고 자발적으로 떠나는 신도들의 뒤를 따르는 장면.",
  },
  {
    id: "claire_nursery",
    ...
    title: "밤을 낮게 밝히는 방",
    body: "클레어 노박은 깨진 객실 하나에서 무거운 가구를 문 쪽으로 옮기고, 남은 천으로 침상 사이에 작은 칸막이를 쳤다. 밝은 전등 대신 덮개를 씌운 황동등 하나만 남겼고, 병뚜껑과 오래된 열쇠로 만든 모빌은 바람이 불 때에도 작은 소리만 냈다. 아이와 임신한 주민이 먼저 잠들자 복도의 발걸음도 자연스럽게 느려졌다. 이곳은 세상이 안전하다고 거짓말하는 방이 아니라, 적어도 오늘 밤의 공포를 함께 낮춰 주는 방이 되었다.",
  ...
  {
    id: "claire_medical_passage",
    triggerStoryEventId: "claire-future",
    triggerStoryChoiceId: "safe_passage",
    priority: 165,
    kicker: "JUJU HOTEL · MEDICAL PASSAGE",
    title: "따뜻한 방을 등진 새벽",
    body: "클레어 노박은 동이 트기 전 호텔 뒤편 비상문을 열었다. 의약품과 초음파 사진을 넣은 가방은 한 손에 들려 있었고, 다른 손은 아직 태어나지 않은 아이를 감쌌다. 문 안쪽에는 쓰지 못한 아기 담요와 황동등의 온기가 남았지만, 젖은 골목의 천 표식은 멀리 의료 거점의 불빛으로 이어졌다. 두 명의 호위가 안개 속에서 기다리는 동안 클레어는 호텔을 한 번 돌아봤다. 더 안전한 출산을 얻는 길은 이곳의 육아실과 자신의 객실, 다시 돌아올 약속을 모두 두고 가는 길이었다.",
    quote: "돌아오겠다고 약속하진 않을게요. 대신 아이와 살아서 저 불빛까지 가겠습니다.",
    image: "/juminjung/assets/cutscenes/claire-medical-passage-v1.png",
    imageAlt: "임신한 클레어 노박이 새벽의 JUJU HOTEL 후문 밖에서 초음파 사진이 든 의료 가방을 들고 따뜻한 객실과 접힌 아기 담요를 돌아보며, 천 표식과 두 호위가 기다리는 차가운 골목 너머 의료 거점 불빛으로 영구 출발하는 장면.",
  },
  {
    id: "eli_quartermaster",
    triggerStoryEventId: "eli-keyring",
    triggerStoryChoiceId: "quartermaster",
    priority: 165,
    kicker: "JUJU HOTEL · DOUBLE LEDGER",
    title: "숨기지 않은 첫 번째 열쇠",
    body: "엘리 터너는 창고 철망 안쪽이 아니라 모두가 볼 수 있는 카운터 위에 황동 열쇠를 내려놓았다. 한 장부에는 선반에서 나간 물자를, 다른 장부에는 시설에 실제로 도착한 물자를 적었다. 서로 맞지 않던 칸에서 통조림 두 개와 발전기용 연료통 하나가 제자리로 돌아왔다. 봉인끈을 다시 묶은 뒤 엘리는 하수도 지도와 분필을 벽걸이에 걸었다. 호텔은 매일 낭비되던 유지비 한 몫을 되찾았지만, 밤길을 먼저 읽어 주던 그의 발걸음은 이제 잠긴 창고 안에 남았다.",
    quote: "뭘 맡았는지 다 적을게. 이번에는 없어져도 내가 먼저 찾을 수 있게.",
    image: "/juminjung/assets/cutscenes/eli-quartermaster-v1.png",
    imageAlt: "엘리 터너가 JUJU HOTEL 지하 창고에서 공개된 황동 열쇠와 두 권의 대조 장부 옆에 되찾은 통조림 두 개와 시설 유지용 연료통을 정리하고, 사용하지 않을 하수도 지도와 분필은 벽에 걸어 둔 장면.",
  },
  {
    id: "eli_safe_passage",
    triggerStoryEventId: "eli-keyring",
    ...
    title: "훔친 열쇠 대신 그린 길",
    body: "엘리 터너는 정문으로 이어지는 큰길을 지도에서 지우고, 무너진 세탁소 뒤편과 배수로, 두 건물 사이의 좁은 서비스 통로를 하나의 길로 이었다. 눈에 띄는 표지판 대신 비에 쉽게 씻기는 분필과 천 조각만 남겼다. 그날 새벽, 보급 주머니를 든 두 사람이 괴물의 흔적이 남은 대로를 피해 호텔 뒤편에 도착했다. 누구도 엘리를 감시하러 따라가지 않았다. 그는 처음으로 훔친 물건이 아니라, 모두가 돌아올 수 있는 길을 들고 돌아왔다.",
    quote: "표시는 오래 남으면 안 돼. 사람은 찾고, 저것들은 지나치게 해야 하니까.",
    image: "/juminjung/assets/cutscenes/eli-safe-passage-v1.png",
    imageAlt: "엘리 터너가 비 내린 폐허의 골목 벽에 작은 분필 표시를 남기고, 보급 주머니를 든 주민들이 위험한 큰길을 피해 JUJU HOTEL로 향하는 장면.",
  },
  {
  ...
  },
  {
    ...
    title: "병실 밖으로 이어진 돌봄",
    body: "루스 벨은 진료실 문에 걸려 있던 교대표를 복도 벽으로 옮겼다. 아이가 잠들지 못한 시간, 붕대를 바꿔야 할 객실, 혼자 계단을 오르기 힘든 사람의 이름 옆에 투숙객들이 차례로 자신의 시간을 적었다. 약품이 없는 자리에는 따뜻한 물과 깨끗한 천, 함께 앉아 줄 의자가 놓였다. 돌봄은 더는 의료진 두 사람의 밤샘이 아니라 호텔 전체가 지키는 생활 규칙이 되었다.",
  ...
  },
  {
    id: "ruth_field_nurse",
    triggerStoryEventId: "ruth-home",
    triggerStoryChoiceId: "field_nurse",
    priority: 165,
    kicker: "JUJU HOTEL · FIELD NURSE NETWORK",
    title: "호텔 밖으로 이어진 붕대",
    body: "루스 벨은 동이 트기 전 호텔 바리케이드 밖에 낡은 의료 가방과 등불을 펼쳤다. 새로 도착한 생존자의 체온을 재고 젖은 붕대를 갈아 주었지만, 깊은 상처는 가리지 않았고 감염이 의심되는 사람은 밧줄 너머에서 따로 기다리게 했다. 평범한 발열은 호텔 문에 닿기 전에 가라앉았고, 모든 처치는 방문 기록에 남았다. 따뜻한 현관 안에는 공동 돌봄팀이 쓰려던 물컵과 담요, 빈 교대표가 그대로 남았다. 돌봄이 길 위로 넓어진 만큼 어둠 속에서 호텔까지 이어진 등불도 더 오래 노출되었다.",
    quote: "낫게 만들 수 없는 상처라도, 숨기지 않고 다음 문까지 데려갈 수는 있어요.",
    image: "/juminjung/assets/cutscenes/ruth-field-nurse-v1.png",
    imageAlt: "루스 벨이 비 내린 새벽 JUJU HOTEL 바리케이드 밖에서 새 일반 방문자의 체온을 재고 붕대를 교체하는 동안, 부상은 드러난 채 유지되고 감염 의심 여행자는 밧줄 너머에 분리되며 호텔 안의 공동 돌봄 물품은 사용되지 않은 장면.",
  },
  {
    ...
    title: "명령 대신 건네받은 열쇠",
    body: "새뮤얼 프라이스는 낡은 경찰 배지를 프런트 서랍 안에 내려놓고, 그 자리에 호텔의 황동 열쇠고리를 받았다. 새 경비대는 계급도 제복도 없이 객실 사람들의 이름과 순찰 시간을 함께 적었다. 손전등과 호루라기, 동쪽 철문부터 계단참까지 이어진 지도가 카운터 위에 놓였다. 그가 다시 선 검문선은 사람을 버리기 위한 경계가 아니라, 누가 돌아오지 않았는지 책임지는 약속이 되었다.",
  ...
  {
    id: "samuel_rescue_patrol",
    triggerStoryEventId: "samuel-duty",
    triggerStoryChoiceId: "search",
    priority: 165,
    kicker: "JUJU HOTEL · RESCUE PATROL",
    title: "명단에서 돌아온 이름",
    body: "새뮤얼 프라이스는 빗물에 번진 검문선 명단을 들고 무너진 도로를 되짚었다. 동이 트기 전, 그는 폐쇄된 검문소 지하에서 명단에 남은 이름 하나를 찾아 JUJU HOTEL의 불빛까지 데려왔다. 생존자는 찢긴 명단 조각을 놓지 않았고, 프런트에서는 다음 날 정식 심사를 기다리게 되었다. 열린 현관 안에는 민간 경비대가 쓰려던 황동 열쇠와 손전등, 빈 순찰 의자가 그대로 남았다. 한 사람을 되찾은 발자국 뒤로 호텔까지 이어진 등불과 낯선 그림자도 함께 길어졌다.",
    quote: "명단을 봉인하면 죄도 묻힐 줄 알았습니다. 이제는 남은 이름을 직접 데려오겠습니다.",
    image: "/juminjung/assets/cutscenes/samuel-rescue-patrol-v1.png",
    imageAlt: "새뮤얼 프라이스가 비 내린 새벽 무너진 검문선에서 명단과 일치하는 생존자 한 명을 JUJU HOTEL로 데려오고, 차가운 구조 경로 뒤에는 수상한 그림자가 남으며 따뜻한 현관 안의 민간 경비대 열쇠와 빈 순찰 의자는 사용되지 않은 장면.",
  },
  {
    ...
    title: "배급표 대신 놓인 접시",
    body: "노아 그랜트는 잠겨 있던 식당 문을 열고 남은 통조림과 말린 뿌리, 향신료를 한 냄비에 모았다. 장부의 몫은 그대로였지만 따로 끓일 때 버리던 물과 불, 남은 조각이 한 끼로 돌아왔다. 투숙객들은 객실 번호가 아니라 빈 의자 순서대로 앉았다. 부엌 열쇠는 다시 그의 허리에 있었고, 배급 기록은 누구나 볼 수 있는 식탁 끝에 놓였다. 그 선택으로 지하의 저울과 압착기는 멈췄고, 적은 재료를 더 오래 나눌 보존식 계획은 식탁 아래 접힌 채 남았다.",
    quote: "내일 몫을 오래 보관하는 대신, 오늘 남은 걸 버리지 않고 같이 먹는 겁니다.",
  ...
  },
  {
    id: "noah_ration_lab",
    triggerStoryEventId: "noah-table",
    triggerStoryChoiceId: "ration_lab",
    priority: 164,
    kicker: "JUJU HOTEL · RATION LAB",
    title: "빈 식탁 아래에 쌓인 내일",
    body: "노아 그랜트는 따뜻한 냄비를 식당으로 올리는 대신 지하 저장실의 저울을 다시 맞췄다. 말린 재료를 세 몫씩 나누고 낡은 압착기로 봉투를 봉할 때마다 선반에는 다음 주를 버틸 작은 식량이 늘어났다. 투숙객이 많을수록 낭비를 더 줄일 수 있는 방식이었다. 그러나 열린 문 너머의 긴 식탁은 어둡고 비어 있었고, 식어 버린 솥 옆에는 아무도 들지 않은 그릇만 포개져 있었다. 호텔은 더 오래 버틸 계산을 얻는 대신 오늘 함께 먹을 이유 하나를 잃었다.",
    quote: "맛은 오늘을 견디게 하고, 보존은 다음 주를 줍니다. 둘 다 가질 식량은 없으니까요.",
    image: "/juminjung/assets/cutscenes/noah-ration-lab-v1.png",
    imageAlt: "노아 그랜트가 JUJU HOTEL 지하 저장실의 낡은 저울과 압착기로 보존식을 세 몫씩 나누어 봉하고, 질서정연한 식량 선반 뒤 열린 문 너머로 어둡고 빈 공동 식탁이 보이는 장면.",
  },
  {
    ...
    body: "토머스 그레이가 마지막 차단기를 올리자 발전기실의 진동이 낮고 고른 박자로 바뀌었다. 벽을 따라 새로 묶은 배선은 진료 구역, 프런트 라디오, 동쪽 방벽의 표시등으로 갈라졌다. 객실 조명은 여전히 필요한 만큼만 켜졌지만, 어느 한쪽을 살리기 위해 다른 쪽을 완전히 포기할 필요는 없어졌다. 낡은 계기판의 바늘이 안정 구간에 머문 채 첫 밤의 부하를 견뎠다.",
    quote: "전기가 남은 게 아니에요. 낭비하던 전기를 되찾은 겁니다.",
    image: "/juminjung/assets/cutscenes/thomas-microgrid-online-v1.png",
    imageAlt: "토머스 그레이가 JUJU HOTEL 발전기실의 새 배전반을 올리고, 정돈된 배선이 진료 구역과 프런트 라디오, 동쪽 방벽 표시등으로 이어지는 가운데 계기판이 안정 구간을 가리키는 장면.",
  },
  {
    id: "thomas_radio_relay",
    triggerStoryEventId: "thomas-grid",
    triggerStoryChoiceId: "signal",
    priority: 164,
    kicker: "JUJU HOTEL · RADIO RELAY",
    title: "빗속에서 돌아온 호출",
    body: "토머스 그레이가 마지막 케이블을 중계기에 물리자 묵어 있던 바늘이 떨리고, 황색 표시등이 호텔에서 외곽 안테나로 이어진 회로를 차례로 밝혔다. 빗속의 폐허 저편에서 작은 응답등이 하나씩 돌아왔다. 프런트에는 이제 길을 묻는 목소리와 구조 요청이 더 자주 닿을 것이다. 그러나 작업대 한쪽의 독립 전력망 설계도는 끝내 접히지 못했고, 비상 연료통과 보조 배전반은 어둠 속에 남았다. 더 많은 사람에게 길을 열어 준 대가로 호텔의 위치도 더 멀리 퍼졌다.",
    quote: "신호가 닿으면 사람도 옵니다. 사람을 부르면, 다른 것도 들을 수 있고요.",
    image: "/juminjung/assets/cutscenes/thomas-radio-relay-v1.png",
    imageAlt: "토머스 그레이가 비 내리는 JUJU HOTEL 옥상 중계실에서 전압계를 들고 마지막 케이블을 연결하자 황색과 녹색 표시등이 외곽 안테나와 먼 폐허의 응답 신호로 이어지고, 뒤편에는 미완성 마이크로그리드 설계와 사용하지 않은 연료통이 남은 장면.",
  },
  {
