...
const seeds:Seed[] = [
  ...
  {id:"eli",name:"엘리 터너",age:17,gender:"남성",role:"좀도둑",description:"지역 골목과 하수도를 아는 경계심 강한 소년.",days:[13,20],stay:4,traits:["Agile","Streetwise"],hidden:["Thief"],aura:aura("theft-risk","Theft Risk","theftRisk",18,"낮은 Trust에서 주변 도난 위험 증가."),portrait:"/juminjung/assets/portraits/eli/neutral-v1.png",offer:{parts:1},items:[item("map","INFORMATION","하수도 지도","호텔 아래 폐쇄 통로가 표시돼 있다.")]},
  ...
  {id:"thomas",name:"토머스 그레이",age:60,gender:"남성",role:"전력시설 기술자",description:"지역 전력망을 관리했던 지친 기술자.",days:[16,23],stay:5,traits:["Engineer","Tired"],hidden:["GridController"],aura:aura("power-optimization","Power Optimization","breakdownRisk",-20,"발전기 연료 소비와 고장 확률 감소."),portrait:"/juminjung/assets/portraits/thomas/neutral-v1.png",offer:{parts:5},items:[item("grid-key","VALUABLE","전력망 제어 키","지역 변전소 접근 키.")]},
